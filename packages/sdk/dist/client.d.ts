...
export declare class TrustChainClient {
    ...
    auditBatch(entries: unknown[]): Promise<AuditBatchResponse>;
    auditReport(): Promise<AuditReportResponse>;
    exportChain(): Promise<ExportChainResponse>;
    ...
    registerPeer(pubkey: string, address: string): Promise<{
        status: string;
    }>;
    trustScore(pubkey: string, context?: string): Promise<TrustScoreResponse>;
    discover(capability: string, options?: DiscoverOptions): Promise<DiscoverResponse>;
    delegate(delegatePubkey: string, options?: {
        scope?: string[];
        max_depth?: number;
        ttl_seconds?: number;
